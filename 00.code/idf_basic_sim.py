...
# application
basic_sim_runner(sim_file = '/home/rodox/Dropbox/99.temp/pt1_inter.idf',
				 epw_file = '/home/rodox/Dropbox/00.master_ufsc/04.source/00.epw/br_sao_paulo_congonhas_ap_tmy_2003-2017.epw',
				 convert = True)
